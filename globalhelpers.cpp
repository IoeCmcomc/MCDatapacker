...
bool GlobalHelpers::isPathRelativeTo(const QString &dirpath, const QString &path,
...
QString GlobalHelpers::toNamespacedID(const QString &dirpath, QString filepath) {
