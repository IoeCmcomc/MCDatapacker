...
pp(getInfoDiff('item', '1.18.2'))
pp(getInfoDiff('tag/block', '1.18.2'))
pp(getInfoDiff('tag/entity_type', '1.18.2'))
pp(getInfoDiff('tag/fluid', '1.18.2'))
pp(getInfoDiff('tag/item', '1.18.2'))
pp(getInfoDiff('tag/biome', '1.18.2'))
pp(getInfoDiff('tag/game_event', '1.18.2'))
#pp(getInfoDiff('tag/configured_structure_feature', '1.18.2'))