...
pp(getInfoDiff('tag/block', '1.20.2'))
pp(getInfoDiff('tag/entity_type', '1.20.2'))
pp(getInfoDiff('tag/fluid', '1.20.2'))
pp(getInfoDiff('tag/instrument', '1.20.2'))
pp(getInfoDiff('tag/item', '1.20.2'))
pp(getInfoDiff('tag/painting_variant', '1.20.2'))
pp(getInfoDiff('tag/point_of_interest_type', '1.20.2'))
pp(getInfoDiff('tag/biome', '1.20.2'))
pp(getInfoDiff('tag/game_event', '1.20.2'))
pp(getInfoDiff('tag/structure', '1.20.2'))
pp(getInfoDiff('tag/world_preset', '1.20.2'))
pp(getInfoDiff('tag/banner_pattern', '1.20.2'))
pp(getInfoDiff('tag/cat_variant', '1.20.2'))
pp(getInfoDiff('tag/flat_level_generator_preset', '1.20.2'))
pp(getInfoDiff('tag/damage_type', '1.20.2'))
