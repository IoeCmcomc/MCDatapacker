...
#pp(getInfoDiff('biome', '1.17'))
#pp(getInfoDiff('block', '1.17'))
#pp(getInfoDiff('dimension', '1.17'))
#pp(getInfoDiff('effect', '1.17'))
#pp(getInfoDiff('enchantment', '1.17'))
#pp(getInfoDiff('entity', '1.17'))
#pp(getInfoDiff('feature', '1.17'))
#pp(getInfoDiff('fluid', '1.17'))
#pp(getInfoDiff('item', '1.17'))
pp(getInfoDiff('tag/block', '1.18'))
pp(getInfoDiff('tag/entity_type', '1.18'))
pp(getInfoDiff('tag/fluid', '1.18'))
pp(getInfoDiff('tag/item', '1.18'))
#pp(getInfoDiff('tag/biome', '1.18'))
#pp(getInfoDiff('tag/configured_structure_feature', '1.18'))