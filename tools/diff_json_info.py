...
#pp(getInfoDiff('biome', '1.18.2'))
#pp(getInfoDiff('block', '1.18.2'))
#pp(getInfoDiff('dimension', '1.17'))
#pp(getInfoDiff('effect', '1.18.2'))
#pp(getInfoDiff('enchantment', '1.18.2'))
pp(getInfoDiff('entity', '1.19'))
#pp(getInfoDiff('feature', '1.17'))
#pp(getInfoDiff('fluid', '1.17'))
# pp(getInfoDiff('item', '1.19'))
pp(getInfoDiff('tag/block', '1.19.3'))
pp(getInfoDiff('tag/entity_type', '1.19.3'))
pp(getInfoDiff('tag/fluid', '1.19.3'))
pp(getInfoDiff('tag/instrument', '1.19.3'))
pp(getInfoDiff('tag/item', '1.19.3'))
pp(getInfoDiff('tag/painting_variant', '1.19.3'))
pp(getInfoDiff('tag/point_of_interest_type', '1.19.3'))
pp(getInfoDiff('tag/biome', '1.19.3'))
pp(getInfoDiff('tag/game_event', '1.19.3'))
pp(getInfoDiff('tag/structure', '1.19.3'))
pp(getInfoDiff('tag/world_preset', '1.19.3'))
pp(getInfoDiff('tag/banner_pattern', '1.19.3'))
pp(getInfoDiff('tag/cat_variant', '1.19.3'))
pp(getInfoDiff('tag/flat_level_generator_preset', '1.19.3'))
