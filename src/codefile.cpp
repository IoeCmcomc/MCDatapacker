...
CodeFile::FileType CodeFile::pathToFileType(const QString &dirpath,
    ...
    static const QVector<QPair<QString,
        ...
        { QStringLiteral("wolf_variant"), CodeFile::WolfVariant },
        { QStringLiteral("enchantment"), CodeFile::Enchantment },
        ...
        { QStringLiteral("trial_spawner"), CodeFile::TrialSpawner },
...
QString CodeFile::fileTypeToName(const CodeFile::FileType type) {
    static QHash<CodeFile::FileType, const char *> const valueMap {
        ...
        { CodeFile::TrialSpawner,
          QT_TRANSLATE_NOOP("CodeFile", "Trial spawner configuration") },
        { CodeFile::TrimMaterial,
          QT_TRANSLATE_NOOP("CodeFile", "Trim material") },
        { CodeFile::TrimPattern,
          QT_TRANSLATE_NOOP("CodeFile", "Trim pattern") },
        { CodeFile::WolfVariant,
          QT_TRANSLATE_NOOP("CodeFile", "Wolf variant") },
        { CodeFile::Enchantment, QT_TRANSLATE_NOOP("CodeFile", "Enchantment") },
        { CodeFile::EnchantmentProvider,
          QT_TRANSLATE_NOOP("CodeFile", "Enchantment provider") },
        { CodeFile::JukeboxSong,
